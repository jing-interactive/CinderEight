...
class WarpTestApp : public AppBasic {
public:	
	void setup();
	void shutdown();
	void update();
...
void WarpTestApp::update()
{
	// there is nothing to update
}

void WarpTestApp::draw()
{
...
void WarpTestApp::resize()
{
	// tell the warps our window has been resized, so they properly scale up or down
	Warp::handleResize( mWarps );
}

void WarpTestApp::mouseMove( MouseEvent event )
{
...
void WarpTestApp::mouseDown( MouseEvent event )
{
	// pass this mouse event to the warp editor first
...
void WarpTestApp::mouseDrag( MouseEvent event )
{
	// pass this mouse event to the warp editor first
...
void WarpTestApp::mouseUp( MouseEvent event )
{
	// pass this mouse event to the warp editor first
...
void WarpTestApp::keyDown( KeyEvent event )
{
...
void WarpTestApp::keyUp( KeyEvent event )
{
	// pass this key event to the warp editor first
