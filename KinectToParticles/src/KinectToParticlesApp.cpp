...
class KinectToParticles : public AppNative
{
...
void KinectToParticles::initFbo()
{
	m_pos = 0;
	m_bufferIn = 0;
	m_bufferOut = 1;
...
void KinectToParticles::loadShaders()
{
	try {
...
void KinectToParticles::mouseDown( MouseEvent event )
{
}

void KinectToParticles::keyDown( KeyEvent event)
{
...
void KinectToParticles::prepareSettings(Settings *settings)
{
...
void KinectToParticles::drawText()
{
...
CINDER_APP_NATIVE( KinectToParticles, RendererGl )
