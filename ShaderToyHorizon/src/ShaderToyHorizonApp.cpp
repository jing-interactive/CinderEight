...
void BritneysSpaceshipApp::resize()
{
...
void BritneysSpaceshipApp::mouseDown( MouseEvent event )
{
	// handle user input
...
void BritneysSpaceshipApp::resetCamera()
{
	mCamera.setEyePoint( Vec3f( 0.0f, 0.0f, 180.0f ) );
